...
public class ReleaseSprint implements ISprint{
    ...
    public ReleaseSprint(List<BacklogItem> backlogItems, Account scrumMaster, Account productOwner, List<Account> developers, List<Account> testers, Project project, Date startTime, Date endTime, IExportBehavior exportBehavior) {
